                    ...
                    <table>
                        ...
                        <tbody>
                            <c:forEach var="p" items="${parametres}">
                                <tr>
                                    <td>${requestScope[c:set var="mKey" value="param_${p.id}_matiere" />${requestScope[mKey]}}</td>
                                    <td><span class="badge badge-mult">${p.operateur.symbole}</span></td>
                                    <td>${p.min} - ${p.max}</td>
                                    <td><strong>${requestScope[c:set var="rKey" value="param_${p.id}_resolution" />${requestScope[rKey]}}</strong></td>
                                    <td class="actions">
